...
var Carousel = _interopDefault(require('react-multi-carousel'));
var reactFullScreen = require('react-full-screen');
var HTMLFlipBook = _interopDefault(require('react-pageflip'));
var RangeSlider = _interopDefault(require('react-bootstrap-range-slider'));
var btnNext = _interopDefault(require('./btnNext~KFWoJnpD.png'));
var btnPrev = _interopDefault(require('./btnPrevPage~BSVBbfnU.png'));
var btnSearch = _interopDefault(require('./btnSearch~DLNMBOGf.png'));
var fullscreen = _interopDefault(require('./btnFullscreen~KzGfHZvw.png'));
...
var Page = React__default.forwardRef(function (props, ref) {
...
function FlipPages(props) {
  var flipBook = React.useRef(null);
  ...
  }, !navigator.maxTouchPoints && props.page !== 0 && /*#__PURE__*/React__default.createElement("a", {
    onClick: props.prevButtonClick
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles["arrow-left"]
  })), /*#__PURE__*/React__default.createElement(HTMLFlipBook, {
  ...
  }, /*#__PURE__*/React__default.createElement(PageCover, null, /*#__PURE__*/React__default.createElement("div", {
    className: stylesCover["body-cover"],
    style: {
      backgroundImage: "url(" + props.book[0] + ")"
    }
  })), props.flipbookPages.map(props.pagesFlipbook), /*#__PURE__*/React__default.createElement(PageCover, null, /*#__PURE__*/React__default.createElement("div", {
    className: stylesCover["body-cover"],
    style: {
      backgroundImage: "url(" + props.book[props.book.length - 1] + ")"
    }
  }))), !navigator.maxTouchPoints && props.page !== props.totalPage - 1 && /*#__PURE__*/React__default.createElement("a", {
...
function ActionsMenu(props) {
  ...
  }, /*#__PURE__*/React__default.createElement(RangeSlider, {
    value: value,
    tooltip: "off",
    size: "sm",
    variant: "light",
  ...
  }, " /  " + props.totalPages), /*#__PURE__*/React__default.createElement("a", {
...
function Magazine(props) {
  ...
  var pagesFlipbook = function pagesFlipbook(item, index) {
    return /*#__PURE__*/React__default.createElement(Page$1, {
      key: index,
      page: index + 1,
      source: item
    }, /*#__PURE__*/React__default.createElement("div", {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, !(flipbookPages.length > 0) && /*#__PURE__*/React__default.createElement(Loading, {
    cover: props.cover
  }), flipbookPages.length > 0 && /*#__PURE__*/React__default.createElement("div", {
    className: "full-screenable-node"
  }, /*#__PURE__*/React__default.createElement(reactFullScreen.FullScreen, {
    handle: handle
  }, !navigator.maxTouchPoints && /*#__PURE__*/React__default.createElement(ActionsMenu, {
    currentPage: page,
  ...
  }), /*#__PURE__*/React__default.createElement(FlipPages, {
    size: props.size,
    book: props.book,
    page: page,
    totalPage: totalPage,
  ...
  }), !navigator.maxTouchPoints && /*#__PURE__*/React__default.createElement("div", {
    id: "carousel-container",
    className: styles$3["carousel-container"]
  }, !navigator.maxTouchPoints && page !== 0 && /*#__PURE__*/React__default.createElement("a", {
  ...
  }, renderThumbnail(props.book[0]), props.book.map(dobleThumbnail), renderThumbnail(props.book[props.book.length - 1]))), !navigator.maxTouchPoints && page !== totalPage - 1 && /*#__PURE__*/React__default.createElement("a", {
...
var ExampleComponent = function ExampleComponent(_ref) {
  var pages = _ref.pages,
      cover = _ref.cover,
      size = _ref.size;
  return /*#__PURE__*/React__default.createElement(Magazine, {
    book: pages,
    cover: cover,
    size: size
  });
